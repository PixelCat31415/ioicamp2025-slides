...
%\usepackage{enumitem}
\usepackage{tikz}
\usetikzlibrary{fit, backgrounds, arrows, arrows.meta, positioning, calc, intersections, tikzmark}
\tikzset {
  overlay node/.style={
...
\usepackage{svg}
\usepackage{twemojis}
\newcommand{\emoji}[1]{\raisebox{-0.1em}{\scalebox{1.3}{\twemoji{#1}}}}
\usepackage{multicol}
...
\newcommand{\yum}[1]{\textcolor{WildStrawberry}{\strong{#1}}}
\newenvironment{centikz}[1][]{
  \begin{figure}[h!]
    \begin{center}
      \begin{tikzpicture}[#1]
}{
...
% \newcommand{\brilliance}[1]{\raisebox{-.25\height}{\includegraphics{images/brilliance_v2/256x/#1_256x.png}}}
\renewcommand*{\emph}[1]{{\bfseries #1}}
\setcounter{tocdepth}{1}

\newfontfamily{\dejavuSans}{DejaVu Sans}
\newfontfamily{\dejavuSerif}{DejaVu Serif}
\newfontfamily{\notoCaAb}{Noto Sans Canadian Aboriginal}
\newcommand{\AkoEmoji}{{\dejavuSans ٩}{\dejavuSerif (ˊ}{\notoCaAb ᗜ}{\dejavuSerif ˋ*)}{\dejavuSans و}}
\newcommand*\todo{\textcolor{WildStrawberry}{\AkoEmoji}}
...
\input{src/intro}
\input{src/lichao-segtree}
\input{src/time-segtree}
\input{src/building-graph}
\input{src/pattern}
\input{src/amortized}
\input{src/outro}
